...
## Struktur: personality -> { greet, idAsk, talk, search, admit, reject }
##
## Portierung von src/data/dialogue.js.
class_name Dialogue
extends RefCounted

const PERSONALITIES := ["polite", "annoyed", "drunk", "arrogant", "aggressive", "nervous"]
...
## Kuenstler am Hintereingang - der Running Gag.
const ARTIST_LINES := [
...
## Ersetzt den Platzhalter in NAME_LINES.
static func with_name(line: String, name: String) -> String:
